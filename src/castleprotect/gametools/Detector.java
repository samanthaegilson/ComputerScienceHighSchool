...
package castleprotect.gametools;
...
public class Detector {
    ...
    public boolean isOverLappingHorizontally(GameObject gameObject) {
        ...
        if (source.top >= target.top && source.top <= target.bottom) {
            return true;
        } else if (source.bottom >= target.top && source.bottom 
                <= target.bottom) {
            return true;
        } else if (target.top >= source.top && target.top 
                <= source.bottom) {
            return true;
        } else if (target.bottom >= source.top && target.bottom 
                <= source.bottom) {
            return true;
        } else {
            return false;
