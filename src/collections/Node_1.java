...
public class Node_1<T> {
    ...
    /**
     * Self reference (pointer, link) to the next node that 'will' be in a
     * 'chain' (linked list)
     */
    public Node next;
     ...
     */
    public Node_1(T data, Node next) {
     ...
     * ALL the possible arguments first. You can use other constructors to call
     * this one.
     *
     * @param data the node data (generic)
     * @param next reference to the next Node object
     ...
     */
    public Node_1(T data, Node next, Node previous) {
        this.data = data;
        this.next = next;
    ...
    public boolean equals(Object object) {
        ...
        if (this.data == null) {
            return false;    // Data inside this object
        }
        if (object == null) {
            return false;    // Parameter sent to this method
        }        // Convert (cast) the object parameter into a "Node" object
        Node that = (Node) object;
        if (that.data == null) {
            return false;    // Data inside the parameter
